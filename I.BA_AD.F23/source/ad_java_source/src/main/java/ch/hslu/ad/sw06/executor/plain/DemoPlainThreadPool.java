...
import ch.hslu.ad.sw06.n21.buffer.sema.BoundedBuffer;
import ch.hslu.ad.sw06.n21.buffer.sema.Consumer;
import ch.hslu.ad.sw06.n21.buffer.sema.Producer;
...
public final class DemoPlainThreadPool {
    ...
    private static final Logger LOG = LogManager.getLogger(DemoPlainThreadPool.class);
