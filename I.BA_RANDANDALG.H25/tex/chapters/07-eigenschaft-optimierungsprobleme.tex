...
Ein Algorithmus $A$ ist ein $\delta$-Approximationsalgorithmus, wenn seine Güte für jede Eingabe höchstens $\delta$ ist:
$$
...
$$
Sprich: Du erreichst mindestens einen $\frac{1}{\delta}$-Anteil des Optimums.
...
$$
|C_{\text{VAC}}| \leq 2 \cdot |C_{\text{Opt}}|
$$
