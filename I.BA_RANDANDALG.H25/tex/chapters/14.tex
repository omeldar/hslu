...
Zeugenkandidat: Ein Objekt, das man leich tzufällig wählen kann (z.B. eine Zahl $a \in \{1, \dots, n-1\}$). Zeuge: Ein Kandidat, der tatsächlich zeigt, dass $n$ nicht prim ist.
