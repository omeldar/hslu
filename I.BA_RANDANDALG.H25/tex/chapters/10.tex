...
\textbf{Problemidee}: Wir haben einen Cache (schnell), der nur $k$ Seiten speichern kann. Es kommt eine Anfrage nach einer Seite:
...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \item Was ist die Konkurrenzgüte und die Konkurrenzfähigkeit bei randomisierten Algorithmen?\newline
