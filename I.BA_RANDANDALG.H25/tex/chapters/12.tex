...
$$
(x + y)^{10} \quad \text{vs. ausmultiplizierte Summe mit vielen Termen}
$$
...
Das ist für grosse $n$ zu langsam und sogar schlechter als klassische determinstische Methoden (in der Vorlesungslogik: Randomisierung bringt hier \enquote{naiv} erst mal nichts, wenn man stumpf ganze Läufe wiederholt).
