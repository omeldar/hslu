...
$$
mit einer festen Konstante $c > 0$, die nicht von $|x|$ abhängt. Das ist genau die \enquote{fixe Lücke $c$} in den Slides.
...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \textbf{Antwort}: Füre $A$ n-mal unabhängig aus und gib JA aus, sobald ein Lauf JA liefert (ODER-Regel). Sonst NEIN.
